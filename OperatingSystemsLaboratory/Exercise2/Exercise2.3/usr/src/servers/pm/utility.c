 ...
 *   do_kerneldoub:     get the double of a number processed in kernel 
 */
 ...
 *                              do_kerneldoub                                *
 *===========================================================================*/
 PUBLIC int do_kerneldoub()
 {
 	message my_msg;
	/*take the message for the user and pass it on the my_msg*/
	my_msg.m1_i1=m_in.m1_i1;
	/*call the kernel to double the given number*/
	_taskcall(SYSTASK,SYS_KERDOUBLE,&my_msg);
	return (my_msg.m1_i1);
 }
